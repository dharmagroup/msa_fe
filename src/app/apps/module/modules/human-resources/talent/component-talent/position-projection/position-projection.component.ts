...
@Component({
  selector: 'app-position-projection',
  templateUrl: './position-projection.component.html',
  styleUrl: './position-projection.component.css'
})
export class PositionProjectionComponent {
